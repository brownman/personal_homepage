ActionController::Routing::Routes.draw do |map|
  ...
  map.root :controller => 'home', :action => 'index', :locale => 'de'
  map.root :controller => 'home', :action => 'index', :path_prefix => '/:locale'
  ...
  map.connect ':controller', :action => 'index', :path_prefix => '/:locale'
